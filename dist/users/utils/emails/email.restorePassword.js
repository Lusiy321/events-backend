...
exports.restorePasswordEmailMsg = void 0;
async function restorePasswordEmailMsg(newPassword) {
    return `<!DOCTYPE html
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            <p><br>Натисніть на
                                                                                                посіляння для переходу
                                                                                                на сайт</p>
                                                                                            <p><br>Ваш новий пароль:
                                                                                                <b>${newPassword}</b>
                                                                                            </p>
                                                                                            <p> <br> </p>
                                                                                            <p><a
                                                                                                    href="${process.env.FRONT_LINK}auth/login">Перейти
                                                                                                    для входу сайт</a>
                                                                                            </p>
                                                                                            <p> <br> </p>
                                                                                        </td>
...
exports.restorePasswordEmailMsg = restorePasswordEmailMsg;
//# sourceMappingURL=email.restorePassword.js.map